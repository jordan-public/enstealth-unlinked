...
import { ENS_SUFFIX } from '@/lib/config';
      ...
      <div className="space-y-6">
          ...
          <div className="border rounded-lg p-6">
            ...
            <div className="space-y-4">
              <p className="text-gray-600 dark:text-gray-400">
                Add these records to your ENS name: {merchantName}
                {ENS_SUFFIX}
              </p>
                ...
                <div className="space-y-2">
                  <div>
                    <code className="text-sm font-mono">
                      stealth:spend = {keys.spendPublicKey}
                    </code>
                  </div>
                  <div>
                    <code className="text-sm font-mono">
                      stealth:view = {keys.viewPublicKey}
                    </code>
                  </div>
                </div>
              </div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                <p>To set these records:</p>
                <ol className="list-decimal list-inside space-y-1 ml-4">
                  <li>Go to the ENS Manager app</li>
                  <li>
                    Register or manage {merchantName}
                    {ENS_SUFFIX}
                  </li>
                  <li>Add text records for stealth:spend and stealth:view</li>
                  <li>Paste the public keys above</li>
                </ol>
              </div>
        ...
        <div className="border rounded-lg p-6 bg-gray-50 dark:bg-gray-900">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <p>
              <strong>ENS Records:</strong> Store your public keys so payers can
